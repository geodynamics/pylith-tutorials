...
\begin{frame}
  ...
  \item Bulk rheologies (constitutive models)
    \begin{itemize}
    \item \statusdone{Isotropic, linear elasticity}
    \item \statusinprogress{Isotropic, linear Maxwell viscoelasticity}
    \item \statusinprogress{Isotropic, linear generalized Maxwell viscoelasticity}
    \item \statusinprogress{Isotropic, power-law viscoelasticity}
    \end{itemize}
...
% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{PyLith v4.2: Boundary and Interface Conditions}
  \summary{}
...
% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{PyLith v4.2: Other Features}
  \summary{}
...
% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{PyLith v4.2: Other Features  (cont.)}
  \summary{}
...
\begin{frame}
  ...
  \includefigure[width=\textwidth]{figs/development-0}
...
\begin{frame}
  ...
  \begin{itemize}
    \hitem{v4.2.1} Bugfixes -- Late August 2025
    \begin{onlyenv}<1>
      \begin{itemize}
      ...
      \end{itemize}
    \end{onlyenv}
    \hitem{v5.0.0} New features -- Late September 2025
    \begin{onlyenv}<2>
      \begin{itemize}
...
\begin{frame}
  ...
  \vfill
  \important{Select the version that matches the release you are using!}
...
\begin{frame}
  ...
  \summary{\url{https://pylith.readthedocs.io/en/stable/user/run-pylith/utilities.html}}
...
\begin{frame}
  ...
  \summary{{\tt CDs parametersgui; ./pylith\_paramviewer}}
