...
\newcommand{\material}[1]{{\color{brown}#1}}
\newcommand{\rheology}[1]{{\color{green}#1}}
...
\newcommand{\eqnannotatemat}[2]{%
  {\color{brown}%
  \underbrace{\color{black}#1}_{\color{brown}\mathclap{#2}}}}

\newcommand{\eqnannotaterhe}[2]{%
  {\color{green}%
...
\newcommand{\component}[1]{{\bfseries\color{blue}#1}}
\newcommand{\property}[1]{{\bfseries\color{purple}#1}}
\newcommand{\cfgblurb}[1]{{\tiny\tt\color{blue}#1}}
\newcommand{\cmdblurb}[1]{{\tiny\tt\color{ltred}#1}}
