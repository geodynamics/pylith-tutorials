...
\subtitle{Overview of CUBIT/Trelis, PyLith, and ParaView}
\author{Brad Aagaard \\
  Charles Williams \\
  Matthew Knepley}
...
\begin{frame}
  ...
  \summary{Bugfix plus improvements to manual and examples}
...
\begin{frame}
  ...
  \summary{Updated development plan coming soon to PyLith User Resources}
