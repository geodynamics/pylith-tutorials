...
% ========================================================== SECTION
\section{Sunrise: 5:30am}
\subsection{Sunset: 8:30pm}

% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{Welcome to Colorado}
  
  \vspace*{-1.5mm}\hspace*{-0.3in}\includegraphics[scale=1.5]{figs/colorado}\par

  \begin{minipage}{2.5in}
    \vspace*{-6.5in}\includegraphics[scale=0.5]{figs/weather}
  \end{minipage}
