...
% 6. Wrong interpolation type (fault slip)
% 7. Wrong data dim for spatial database (slip)
%
% Not covered
%
      ...
      \begin{bashcode}
        ...
        facilities of 'dirichlettimedependent':
            auxiliary_subfields=<component name>: Discretization information for auxiliary subfields.
                current value: 'auxiliary_subfields', from {file='lib/python3.12/site-packages/pythia/pyre/inventory/ConfigurableClass.py', line=26, function='__set__'}
                configurable as: auxiliary_subfields
            db_auxiliary_field=<component name>: Database for physical property parameters.
                current value: 'simpledb', from {imported} via {file='step02_sheardisp.cfg', line=75, column=-1}
...
\begin{frame}[t,fragile]
 ...
 -- unknown component 'pylithapp.timedependent.materials.elasticity.auxiliary_subfields.shear_modulus'
  ...
  \tsdebug[Examine line 112 of \pylith{pylithapp.cfg}. Lookup \pylith{Elasticity} and \pylith{IsotropicLinearElasticity} components]\pause\\[1pt]
...
# -- many lines omitted --
 ...
 >> libsrc/pylith/topology/MeshOps.cc:804:static void pylith::topology::MeshOps::checkMaterialLabels(const pylith::topology::Mesh &, pylith::int_array &)
 -- error (user-input)
...
# -- many lines omitted --
 ...
 >> libsrc/pylith/problems/TimeDependent.cc:342:virtual void pylith::problems::TimeDependent::initialize()
 -- info (application-flow)
...
[0]PETSC ERROR: #1 static PetscErrorCode pylith::topology::FieldQuery::queryDBPointFn(PylithInt, PylithReal, const PylithReal *, PylithInt, PylithScalar *, void *)() at libsrc/pylith/topology/FieldQuery.cc:334
[0]PETSC ERROR: #2 DMProjectPoint_Func_Private() at src/dm/impls/plex/plexproject.c:143
[0]PETSC ERROR: #3 DMProjectPoint_Private() at src/dm/impls/plex/plexproject.c:545
[0]PETSC ERROR: #4 DMProjectLocal_Generic_Plex() at src/dm/impls/plex/plexproject.c:1083
[0]PETSC ERROR: #5 DMProjectFunctionLocal_Plex() at src/dm/impls/plex/plexproject.c:1114
[0]PETSC ERROR: #6 DMProjectFunctionLocal() at src/dm/interface/dm.c:8361
[0]PETSC ERROR: #7 void pylith::topology::FieldQuery::queryDB()() at libsrc/pylith/topology/FieldQuery.cc:228
Fatal error. Calling MPI_Abort() to abort PyLith application.
...
# -- many lines omitted --
 ...
 >> libsrc/pylith/topology/FieldOps.cc:224:static void pylith::topology::FieldOps::checkSubfieldsExist(const pylith::string_vector &, const std::string &, const pylith::topology::Field &)
 -- error (user-input)
...
Traceback (most recent call last):
  File "lib/python3.12/site-packages/pylith/apps/PetscApplication.py", line 55, in onComputeNodes
    self.main(*args, **kwds)
  File "lib/python3.12/site-packages/pylith/apps/PyLithApp.py", line 85, in main
    self.problem.initialize()
  File "lib/python3.12/site-packages/pylith/problems/Problem.py", line 212, in initialize
    ModuleProblem.initialize(self)
  File "lib/python3.12/site-packages/pylith/problems/problems.py", line 165, in initialize
...
# -- many lines omitted --
 ...
 >> libsrc/pylith/topology/FieldQuery.cc:473:static void pylith::topology::_FieldQuery::findQueryIndices(FieldQuery::DBQueryContext *, const pylith::string_vector &)
 -- error (user-input)
...
2 TS dt 0.2 time 0.2
    0 SNES Function norm 3.245094761944e+00
      Linear solve converged due to CONVERGED_ATOL iterations 14
    1 SNES Function norm 3.376811091599e-08
    Nonlinear solve converged due to CONVERGED_FNORM_ABS iterations 1
3 TS dt 0.2 time 0.4
 >> /Users/baagaard/tmp/pylith-5.0.0-macOS-12.0-arm64/lib/python3.12/site-packages/pylith/problems/Problem.py:222:finalize
 -- info (application-flow)
 -- Finalizing problem.
\end{bashcode}
