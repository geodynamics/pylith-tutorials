...
\begin{frame}
  ...
  \only<2>{\includegraphics[scale=0.2]{figs/typical-Bartlow-2010}}
  \only<3>{\includegraphics[scale=0.2]{figs/typical-Diao-etal-2018}}
  \only<4>{\includegraphics[scale=0.2]{figs/typical-Douilly-etal-2015}}
  \only<5>{\includegraphics[scale=0.2]{figs/typical-Guo-etal-2020}}
  \only<6>{\includegraphics[scale=0.2]{figs/typical-Todd-etal-2018}}
  \only<7>{\includegraphics[scale=0.2]{figs/typical-Williams-Wallace-2018}}
  \only<8>{\includegraphics[scale=0.2]{figs/typical-Yao-Yang-2022}}
...
\begin{frame}
  ...
  \only<2>{\includegraphics[scale=0.2]{figs/atypical-Berne-etal-2023}}
  \only<3>{\includegraphics[scale=0.2]{figs/atypical-Chen-etal-2025}}
  \only<4>{\includegraphics[scale=0.2]{figs/atypical-Heckman-2013}}
  \only<5>{\includegraphics[scale=0.2]{figs/atypical-Jha-Juanes-2014}}
  \only<6>{\includegraphics[scale=0.2]{figs/atypical-McLaskey-etal-2014}}
  \only<7>{\includegraphics[scale=0.2]{figs/atypical-Muirhead-etal-2025}}
  \only<8>{\includegraphics[scale=0.2]{figs/atypical-Thompson-etal-2014}}
...
Grant Block \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0009-0003-3402-0923 \\
Daniel Douglas \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0000-0002-7871-018X \\
Lorraine Hwang \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0000-0002-1021-3101 \\
Evan Marschall \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0009-0003-0916-6656 \\
Ritwik Patil \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0009-0008-3305-6728 \\
Rezgar Shakeri \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0000-0003-4790-7016 \\
Robert Walker \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0000-0001-7856-1949 \\
Peng Zhai \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0000-0001-5899-4421 \\
Zechao Zhuo \includegraphics[height=1em]{images/ORCIDiD_icon32x32}0000-0002-8163-5731
...
\begin{frame}[t]
  ...
  \begin{overlayarea}{\textwidth}{7.1cm}
    \only<1>{\includegraphics[height=6.9cm]{figs/pylith-timeline-00}}
    \only<2>{\includegraphics[height=6.9cm]{figs/pylith-timeline-01}}
    \only<3>{\includegraphics[height=6.9cm]{figs/pylith-timeline-02}}
    \only<4>{\includegraphics[height=6.9cm]{figs/pylith-timeline-03}}
    \only<5>{\includegraphics[height=6.9cm]{figs/pylith-timeline-04}}
    \only<6>{\includegraphics[height=6.9cm]{figs/pylith-timeline-05}}
    \only<7>{\includegraphics[height=6.9cm]{figs/pylith-timeline-06}}
    \only<8>{\includegraphics[height=6.9cm]{figs/pylith-timeline-07}}
    \only<9>{\includegraphics[height=6.9cm]{figs/pylith-timeline-08}}
    \only<10>{\includegraphics[height=6.9cm]{figs/pylith-timeline-09}}
    \only<11>{\includegraphics[height=6.9cm]{figs/pylith-timeline-10}}
    \only<12>{\includegraphics[height=6.9cm]{figs/pylith-timeline-11}}
    \only<13>{\includegraphics[height=6.9cm]{figs/pylith-timeline-12}}
    \only<14>{\includegraphics[height=6.9cm]{figs/pylith-timeline-13}}
  \end{overlayarea}
...
\begin{frame}[t,fragile]
  \frametitle{PyLith v4.2 $\rightarrow$ PyLith v5.0}
  \summary{Journal channels - now a small set of channels with predefined names}
...
\begin{cfgcode}
[pylithapp]
# Turn off 'application-flow' channel (default is on)
...
\begin{frame}[t,fragile]
  \frametitle{PyLith v4.2 $\rightarrow$ PyLith v5.0}
  \summary{Nondimensionalization - {\ttfamily normalizer} $\rightarrow$ {\ttfamily scales}, {\ttfamily displacement\_scale}}
...
\begin{frame}[t,fragile]
  \frametitle{PyLith v4.2 $\rightarrow$ PyLith v5.0}
  \summary{Modular mesh initialization}
...
\begin{frame}
  ...
  \href{run:movies/formulation.mp4}{\includegraphics[width=\textwidth]{movies/formulation}}
...
% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{Nondimensionalization: Setting the length scale}
  \summary{}

The length scale can impact solver performance, especially when there is a fault.

\vfill
\important{Important: Set the length scale to the nominal (usually minimum) discretization size.}
...
\begin{frame}
  ...
  \href{run:movies/fault.mp4}{\includegraphics[width=\textwidth]{movies/fault}}
...
% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{Performance for 2D elasticity + prescribed slip}
  \summary{Solver performance for elasticity with faults is excellent!}

  \only<1>{Version 3.x}
  \only<2>{Version 4.1}
  \only<3>{Version 5.x}\par
  \only<1>{\includefigure[height=7.0cm]{figs/solver-performance-2d-0}}
  \only<2>{\includefigure[height=7.0cm]{figs/solver-performance-2d-1}}
  \only<3>{\includefigure[height=7.0cm]{figs/solver-performance-2d-3}}
...
% ------------------------------------------------------------ SLIDE
\begin{frame}
  \frametitle{Performance for 3D elasticity + prescribed slip}
  \summary{Solver performance for elasticity with faults is excellent!}

  \only<1>{Version 3.x}
  \only<2>{Version 4.1}
  \only<3>{Version 5.x}\par
  \only<1>{\includefigure[height=7.0cm]{figs/solver-performance-3d-0}}
  \only<2>{\includefigure[height=7.0cm]{figs/solver-performance-3d-1}}
  \only<3>{\includefigure[height=7.0cm]{figs/solver-performance-3d-3}}
...
\begin{frame}[fragile]
  ...
  \begin{enumerate}
    ...
    \begin{bashcode}
      ...
      mkdir playpen
      cp -r src/pylith-5.0.1/examples playpen/
    \end{bashcode}
