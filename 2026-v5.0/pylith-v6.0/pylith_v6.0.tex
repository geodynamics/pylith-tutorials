...
\begin{frame}
  ...
  \item Simpler implementation of "components"
...
\begin{frame}
  ...
  \item Restructure governing equations and materials (simplify user interface)
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Monitor running simulation \\
      \noindent\vdots
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Monitoring of running simulation
    ...
    \noindent\vdots
    \item Steer running simulation (use case?)
  \end{enumerate}
