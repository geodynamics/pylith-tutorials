...
\tikzstyle{generic} = [rectangle, blur shadow={shadow blur steps=5}]
\tikzstyle{software} = [generic, rounded corners=0.5em]

\tikzstyle{phase} = [generic, 
                      draw=dkyellow!80!black,
                      top color=yellow,
                      bottom color=dkyellow]
\tikzstyle{cig} = [software, 
                      draw=orange!80!black,
                      top color=ltorange!50!white,
                      bottom color=orange]
\tikzstyle{open} = [software,
                      draw=green!80!black,
                      top color=ltgreen!20!white,
                      bottom color=green]
\tikzstyle{free} = [software,
                      draw=blue!80!black,
                      top color=ltblue!20!white,
                      bottom color=blue]
\tikzstyle{commercial} = [software,
                      draw=ltred!80!black,
